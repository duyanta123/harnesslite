...
const en = {
  ...
  'check.harness.upstream': 'Upstream: {version}',
  ...
  'source.managed': 'installed by HarnessLite',
  ...
  'plugins.updates.check': 'Check for updates',
  'plugins.updates.available': 'Update → {version}',
  ...
  'plugins.sources.curatedNote':
    'A curated catalog: searching only filters the entries listed in it — switch to the npm source to search the whole registry.',
  ...
  'usage.span': 'Statement span',
  'usage.spark.today': 'today',
  'usage.spark.peak': 'peak',
  'usage.spark.avg': 'avg',
  ...
  'settings.notificationTestHint':
    'Register HarnessLite with the operating system and send one test message.',
  'settings.notificationTestAction': 'Send test',
  'settings.section.projects': 'Projects',
  'settings.section.projectsHint': 'Folders this app supervises, and the profile each one uses.',
  'settings.section.behavior': 'Behavior',
  'settings.section.behaviorHint': 'How the app starts, and how it is reached.',
  'settings.section.service': 'Service',
  'settings.section.serviceHint': 'How the background Harness runs and reports.',
  'settings.section.notifications': 'Notifications',
  'settings.section.notificationsHint': 'When the app should get your attention.',
  ...
  'recovery.restored':
    'HarnessLite found an interrupted plugin operation and restored the profile before Harness started.',
  'recovery.failed':
  ...
  'recovery.changedGuard':
    'If the profile changed after this preview, HarnessLite stops and asks for a fresh review.',
  'recovery.noRetry':
  ...
  'profileRecovery.rolledBack':
    'Profile {failed} could not start. HarnessLite automatically returned to the last-known-good profile {recovered}.',
...
const zh: Record<MessageKey, string> = {
  ...
  'check.harness.upstream': '上游最新 {version}',
  ...
  'source.system': '系统安装',
  'source.managed': '由 HarnessLite 安装',
  ...
  'plugins.enable': '启用',
  'plugins.disable': '停用',
  'plugins.updates.check': '检查更新',
  'plugins.updates.available': '可更新 → {version}',
  ...
  'plugins.sources.curatedNote': '人工收录目录：搜索只在收录的条目里过滤，不查 npm 全量；要按名字找包请切到 npm 来源。',
  ...
  'settings.notificationTestHint': '向操作系统注册 HarnessLite，并发送一条测试消息。',
  'settings.notificationTestAction': '发送测试',
  'settings.section.projects': '项目',
  'settings.section.projectsHint': '本应用接管的项目文件夹，以及各自使用的配置。',
  'settings.section.behavior': '行为',
  'settings.section.behaviorHint': '应用的启动方式与唤起方式。',
  'settings.section.service': '服务',
  'settings.section.serviceHint': '后台 Harness 的运行与上报方式。',
  'settings.section.notifications': '通知',
  'settings.section.notificationsHint': '应用何时应当提醒你。',
  ...
  'recovery.changedGuard': '如果配置在预览后发生变化，HarnessLite 会停止操作并要求重新检查。',
  ...
  'profileRecovery.rolledBack':
    '配置 {failed} 无法启动，HarnessLite 已自动回退到上一个健康配置 {recovered}。',
